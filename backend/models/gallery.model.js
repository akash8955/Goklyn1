...
// Album model is now imported from Album.js
// Update item count method for GalleryItem
GalleryItem.updateItemCount = async function(albumId) {
  const count = await this.countDocuments({ album: albumId });
  const Album = require('./Album');
  return Album.findByIdAndUpdate(albumId, { itemCount: count });
};

// Export the model directly to ensure pagination works
